...
def CreateEndpoint():
    ...
    endpoint = aiplatform.Endpoint.create(
        display_name=ENDPOINT_DISPLAY_NAME, project=os.getenv("PROJECT_ID_Genai"), location=os.getenv("LOCATION")
    )  
    # 创建 Vertex AI 端点用于模型部署

    # kade_taxi_fare_prediction_endpoint
    print(endpoint.display_name)  
    # projects/601797833546/locations/us-central1/endpoints/3036590531661529088
