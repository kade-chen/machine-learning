...
prediction = explain_tabular_sample(os.getenv("PROJECT_ID_Genai"), os.getenv("LOCATION"), "projects/601797833546/locations/us-central1/endpoints/3036590531661529088", test_json)  
